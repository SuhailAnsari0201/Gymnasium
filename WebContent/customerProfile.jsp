    	...
    	<div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                  <form class="form" action="CustomerController?action=updateCustomerProfile&customerId=<%=customer.getCustomerId() %>" method="get" id="registrationForm">
