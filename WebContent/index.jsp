...
<html>
				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li><a href="customerSignUp.jsp">Registration</a></li>
						</ul>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						...
						<p>Building and maintaining muscle is necessary for all of us, especially as we age. And the earlier we start, the better.</p>
				...
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						...
						<h3>Running</h3>
						<p>Everyone knows that running is a great way to get into shape, but it also can benefit almost every part of your body and your lift</p>
						<p><a href="#" class="btn btn-primary btn-outline btn-sm">More <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						...
						<h3>Yoga</h3>
						<p>Maintaining a regular yoga practice can provide physical and mental health benefits,and much more..</p>
						<p><a href="#" class="btn btn-primary btn-outline btn-sm">More <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
				<br>
			...
			<div class="row row-bottom-padded-md">
				<div class="col-md-12">
					<ul id="fh5co-portfolio-list">
						...
						<li class="one-third animate-box" data-animate-effect="fadeIn" style="background-image: url(images/gal1.jpg); ">
							<a href="#">
						...
						<li class="one-third animate-box" data-animate-effect="fadeIn" style="background-image: url(images/gal2.jpg); ">
							<a href="#">
								<div class="case-studies-summary">
									<span>Customers</span>
						...
						<li class="one-third animate-box" data-animate-effect="fadeIn" style="background-image: url(images/gal3.jpg); ">
							<a href="#">
								<div class="case-studies-summary">
						...
						<li class="one-third animate-box" data-animate-effect="fadeIn" style="background-image: url(images/gal4.jpg); "> 
							<a href="#">
								<div class="case-studies-summary">
									<span>Web Design</span>
									<h2>Wide indore!</h2>
						...
						<li class="one-third animate-box" data-animate-effect="fadeIn" style="background-image: url(images/gal5.jpg); ">
							<a href="#">
								<div class="case-studies-summary">
									<span>Web Design</span>
									<h2>24X7 open</h2>
						...
						<li class="two-third animate-box" data-animate-effect="fadeIn" style="background-image: url(images/gal6.jpg); ">
							<a href="#">
								<div class="case-studies-summary">
									<span>Illustration</span>
									<h2>Natural Light Source</h2>
								</div>
							</a>
						</li>
						<li class="one-third animate-box" data-animate-effect="fadeIn" style="background-image: url(images/gal7.jpg); ">
							<a href="#">
								<div class="case-studies-summary">
									<span>Web Design</span>
									<h2>Private Trainer</h2>
								</div>
							</a>
						</li>
					</ul>		
			...
			<div class="row">
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="fh5co-contact-info">
						...
						<ul>
							<li class="address">8th KM Mile stone from, <br> Ghaziabad National Highway(NH-58),<br> Delhi-Merrut Expy,Duhai,Ghaziabd,<br> U.P(201206) </li>
							<li class="phone"><a href="tel://1234567920">+91 9634324610</a></li>
							<li class="email"><a href="mailto:info_Suhail@gmail.com">info_suhail@gmail.com</a></li>
							<li class="url"><a href="http://gettemplates.co">gymnasium.com</a></li>
						</ul>
					</div>
	...
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9006.759012698758!2d77.48513208999297!3d28.73804976996276!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cf3f769c70f6f%3A0xc15ae694810c0c70!2sR.D.Engineering%20College!5e0!3m2!1sen!2sin!4v1567514211067!5m2!1sen!2sin" width="1500" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
	<footer id="fh5co-footer" class="fh5co-bg" style="background-image: url(images/img_bg_1.jpg);" role="contentinfo">
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">&copy; 2019. All Rights Reserved Under RDEC College.</small> 
						<small class="block">Designed by Suhail And its team.</small>
					</p>
					<p>
